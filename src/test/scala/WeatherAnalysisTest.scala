...
//      5 -> (8, 2)
//    )
//    assert(WeatherAnalysis.getFailedLine(resultMap3, totalNumberOfPasses, totalNumberOfFails) == 3)
//  }
...
//    assert(WeatherAnalysis.summarizeFailLines(resultList) == (resultMap, totalNumberOfPasses, totalNumberOfFailures))
//  }
//}